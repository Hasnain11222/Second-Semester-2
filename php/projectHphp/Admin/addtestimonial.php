...
<head>
    ...
    <title>Dashboard - Add New Testimonial</title>
...
<h1  style = "text-align : center;">Welcome To Our New Testimonial Page</h1>
...
<form action ="#" method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    <label for="" class="form-label">Descriptaion</label>
    <input type="text" name="Descriptaion" class="form-control" >
  </div>
...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO `testimonial`(`ID`, `Name`, `Descriptaion`, `courses`,`Picture`) VALUES (null,'$Name','$Descriptaion','$courses','$PictureName')";
